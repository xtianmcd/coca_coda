...
def build_detection_graph(input_type, detection_model, input_shape,
  ...
  slim.train.get_or_create_global_step()
...
def _export_inference_graph(input_type,
  ...
  saver_kwargs = {} #{'final_fc_bias':final_fc_bias,'final_fc_weights':final_fc_weights,'first_bias':first_bias,'first_weights':first_weights,'global_step':global_step,'second_bias':second_bias,'second_weights':second_weights}
...
def profile_inference_graph(graph):
  ...
  tf.profiler.profile(graph,cmd='graph',options=(
